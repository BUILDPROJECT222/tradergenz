    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 3,
          name: 'LUA',
          imageUrl: 'https://i.ibb.co.com/4wRMDYn4/Roblox-Logo-2021-removebg-preview.png',
          status: 'Beginner'
        },
        {
          id: 4,
        ...
        },
        {
          id: 7,
          name: 'Solidity',
          imageUrl: 'https://i.ibb.co.com/p68cMQXg/solidity-rotated-logo-white-background-2-M94-Y35-removebg-preview.png',
          status: 'Intermediate'
        },
        {
          id: 8,
          name: 'Rust',
          imageUrl: 'https://i.ibb.co.com/Lh62Z1vn/OIP-2-removebg-preview.png',
          status: 'Intermediate'
        },
        {
          id: 12,
      ...
      tools: [
        ...
        },
        {
          id: 4,
          name: 'Roblox Studio',
          imageUrl: 'https://i.ibb.co.com/MkNxqsYP/roblox-studio-scaled.png',
          status: ''
        },
      ]
    };
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.ibb.co.com/23P7rsq7/Screenshot-2025-12-19-231201.png" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Riandi Aka Jimmy. I'm a developer from Bandung, West Java. I
            have 2 year of experience in web3 development and 3 months of experience in roblox development.
